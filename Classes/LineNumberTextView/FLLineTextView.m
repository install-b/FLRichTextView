...
{
    NSArray *solverTokens =  @[
                               [FLTextContainerToken tokenWithName:@"html_tags"
                                            expression:@"(<\\/?[a-z][^<>]*>)"
                                            attributes:@{
                                                         NSForegroundColorAttributeName : RGB(25, 0, 151)}],
                               [FLTextContainerToken tokenWithName:@"a_tag"
                                            expression:@"(<\\/?[a][^<>]*>)"
                                            attributes:@{
                                                         NSForegroundColorAttributeName : RGB(24, 104, 10)}],
                               [FLTextContainerToken tokenWithName:@"img_tag"
                                            expression:@"(<\\/?[img][^<>]*>)"
                                            attributes:@{
                                                         NSForegroundColorAttributeName : RGB(148, 0, 151)}],
                               [FLTextContainerToken tokenWithName:@"html_entities"
                               ...
                               [FLTextContainerToken tokenWithName:@"comment"
                                            expression:@"<!--(.*?)-->"
                                            attributes:@{
                                                         NSForegroundColorAttributeName : RGB(31, 131, 0),
                                                         NSFontAttributeName : self.italicFont
                                                         }],
                               [FLTextContainerToken tokenWithName:@"annotation"
                                                        expression:@"/\\*{1,2}[\\s\\S]*?\\*/"
                                                        attributes:@{
                                                                     NSForegroundColorAttributeName : RGB(31, 131, 0),
                                                                     NSFontAttributeName : self.italicFont
                                                                     }],
                               [FLTextContainerToken tokenWithName:@"tagclass"
                                                        expression:@"(html|body|)"
                                                        attributes:@{
                                                                     NSForegroundColorAttributeName : RGB(11, 32, 200),
                                                                     NSFontAttributeName : self.italicFont
                                                                     }],
                               [FLTextContainerToken tokenWithName:@"stlyes"
                                                        expression:@"(padding:|border:|height:|width:|margin:|outline:|font-family:|content:|color:|font:|overflow:|overflow-y:|overflow-x:)"
                                                        attributes:@{
                                                                     NSForegroundColorAttributeName : RGB(200, 10, 20),
                                                                     NSFontAttributeName : self.italicFont
                                                                     }],
                               [FLTextContainerToken tokenWithName:@"attributes"
                                            expression:@"(?<==)('|\").*?\\1(?=.*?>)"
                                            attributes:@{
